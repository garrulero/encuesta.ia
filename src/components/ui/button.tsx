...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-accent text-accent-foreground border-2 border-t-[hsl(var(--border-light))] border-l-[hsl(var(--border-light))] border-b-[hsl(var(--border-dark))] border-r-[hsl(var(--border-dark))] active:border-b-[hsl(var(--border-light))] active:border-r-[hsl(var(--border-light))] active:border-t-[hsl(var(--border-dark))] active:border-l-[hsl(var(--border-dark))]",
        destructive:
